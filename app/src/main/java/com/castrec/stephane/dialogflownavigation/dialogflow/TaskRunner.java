package com.castrec.stephane.dialogflownavigation.dialogflow;
...
public class TaskRunner {
    ...
    public TaskRunner(ChatbotCallback callback, SessionName session, SessionsClient sessionsClient, String text) {
        this.chatbotCallback = callback;
        this.session = session;
        this.sessionsClient = sessionsClient;
        this.queryInput = QueryInput.newBuilder().setText(
                TextInput.newBuilder().setText(text).setLanguageCode("fr-FR")).build();;
    }
